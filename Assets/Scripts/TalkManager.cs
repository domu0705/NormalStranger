...
public class TalkManager : MonoBehaviour
{
    ...
    */
    ...
    void GenerateTalkData()
    {
        ...
        talkData.Add(62000, new string[] { "[다니]" + "\n" + "\n" + "아~ 집에 가고싶다.:0" });
        ...
        talkData.Add(66000, new string[] { "[규니]" + "\n" + "\n" + "이따 뭐먹지:0" });
        ...
        talkData.Add(71000, new string[] { "[닉]" + "\n" + "\n" + "아니 어제 내 옆자리 존과 앞자리 릴리가 회사를 그만뒀어.:0",
                                           "[닉]" + "\n" + "\n" + "그리고 새 인공지능이 하나 더 추가됐다고!:0",
                                           "[닉]" + "\n" + "\n" + "...여기서도 잘리면 난 끝이야...:0",
                                         });
        talkData.Add(72000, new string[] { "[오즈비]" + "\n" + "\n" + "이번주 주말에 인공지능 반대 시위가 열린대.:0",
                                           "[오즈비]" + "\n" + "\n" + "너도 갈거지?:0"
                                         });
        talkData.Add(73000, new string[] { "[주]" + "\n" + "\n" + " 일이 왜이렇게 많은거야? :0",
                                           "[주]" + "\n" + "\n" + " 오늘도 일찍 못 들어가겠네.:0"
                                         });
        ...
        talkData.Add(10 + 20000, new string[] { "[???]"+"\n"+"\n"+"......씨?:6", "[???]"+"\n"+"\n"+"피트라씨?:7",
                                                ...
                                                "[???]"+"\n"+"\n"+"피.트.라.씨?:7",
                                                "[피트라]"+"\n"+"\n"+"....네??:4",
                                                "[조니]"+"\n"+"\n"+"그러니까 신디씨에게 맡겨놓은 문서 처리 좀 부탁해요. :5",
                                                "[피트라]"+"\n"+"\n"+".....예....? :4",
                                                "[조니]"+"\n"+"\n"+"부탁해요. 최대한 빨리.:5",
                                                "[피트라]"+"\n"+"\n"+".....아?.. 네네. 알겠습니다.:2",
        ...
        talkData.Add(11 + 30000, new string[] {  "[신디]"+"\n"+"\n"+"안녕하세요~?:8",
                                                "[신디]"+"\n"+"\n"+"아 문서요? 여기요~:9",
                                                "[신디]"+"\n"+"\n"+"옆 사무실 B동의 그린씨에게 전달 부탁해요~:8",
                                                "[피트라]"+"\n"+"\n"+"( 그린씨... 금발머리.. ):3",
                                                "[피트라]"+"\n"+"\n"+"( 정신은 없어도 기억력은 좋군. ):1",
                                                "[신디]"+"\n"+"\n"+"아! 사람들과 부딪히지 않게 조심하세요~:9",
                                                "[신디]"+"\n"+"\n"+"요즘 인공지능에게 일자리를 빼앗길까봐..:8",
                                                "[신디]"+"\n"+"\n"+"다들 늘 화가 잔뜩 나있으니까요~!:8",
                                                "\n"+"\n"+"( 문서를 얻었다. ):0",
                                             });
        ...
        /*40 - 기타 대사들*/
        talkData.Add(40 + 30000, new string[] { "[신디]" +"\n" + "\n" + "조심히.. 들어가요~:8",
                                                "[신디]" +"\n" + "\n" + "엘레베이터는 복도 끝에 있답니다~:8",
                                                });
        talkData.Add(40 + 50000, new string[] { "[마린]" + "\n" + "\n" + "안가고 뭐해요? :15" });
        ...
        talkData.Add(61 + 10000, new string[] {"[피트라]" +"\n" + "\n" + "다들 뭐하는거야? 아무렇지도 않잖아..? :4",
                                              "[???]" +"\n" + "\n" + "삐비빅:0",
                                              "[피트라]" +"\n" + "\n" + "문자? :3" ,
                                              "[???]" +"\n" + "\n" + "수리 필요"+"\n"+"수리 장비 3개를 모아 3층의 '수리 센터' 방문 권고. :0",
                                              "[???]" +"\n" + "\n" + "수리 장비는 B, C, D 동에 있음. :0" ,
                                              "[피트라]" +"\n" + "\n" + "지금 나보고 수리를 도우라고? :4" ,
        ...
        talkData.Add(70 + 9000, new string[] { "[문]" + "\n" + "\n" + "-- ---- --- ---- ----.:0",
                                               "[피트라]" + "\n" + "\n" + "음? 문이 고장났나보네.:3",
                                              });
        talkData.Add(70 + 8000, new string[] { "[문]" + "\n" + "\n" + "-- --- ----.:0",
                                               "[피트라]" + "\n" + "\n" + "이건 무슨 문일까.:3",
                                              });
        ...
        talkData.Add(82 + 9000, new string[] { "[문]" + "\n" + "\n" + "현재 시간에는 사용이 불가능한 문입니다.:0",
                                                "[피트라]" +"\n" + "\n" + "조니상사에게.. 찾아가보자.:4" ,
                                                "[피트라]" +"\n" + "\n" + "설마 회사에서 나갈 방법이 없겠어?:4" ,
                                             });
        ...
        talkData.Add(82 + 7500, new string[] { "[피트라]" + "\n" + "\n" + "앗, 안계시잖아..? :4",
                                               ...
                                               "[피트라]" +"\n" + "\n" + "말도.. 안돼... :3" ,
                                               "[피트라]" +"\n" + "\n" + "저번에 본 마린씨의 문서... 날 해고시키려는게 아니었어. :3" ,
                                               "[피트라]" +"\n" + "\n" + "날 폐기하려는 거였어! :4" ,
                                               "[피트라]" +"\n" + "\n" + "어제도 정전이 아니었어. :3" ,
        ...
        talkData.Add(80 + 62000, new string[] { "[다니]" + "\n" + "\n" + "-~ -- ----. :0" });
        ...
        talkData.Add(91 + 40000, new string[] {"[그린]" +"\n" + "\n" + "피트라씨..!:24",
                                              ...
                                              "[그린]" +"\n" + "\n" + "며칠 전에 절 못알아보셔서 얼마나 서운했는지 몰라요. :12" ,
        ...
        /*90 - 기타 대사들*/
        talkData.Add(90 + 30000, new string[] { "[신디]" + "\n" + "\n" + "...:8" });
        talkData.Add(90 + 50000, new string[] { "[마린]" + "\n" + "\n" + "--:15" });
        ...
        talkData.Add(110 + 10000, new string[] { "[피트라]" + "\n" + "\n" + "...:2",
                                                "[피트라]" + "\n" + "\n" + "이제 프로그래밍 된 일은 전부 끝났어:2",
                                                "[피트라]" + "\n" + "\n" + "꽤 괜찮은 하루가 될 것 같은 생각이 드는걸...:1",
                                                "[피트라]" + "\n" + "\n" + "어디...:2",
                                                "[피트라]" + "\n" + "\n" +"내 맘대로 걸어볼까?:1",
                                                });
    }
