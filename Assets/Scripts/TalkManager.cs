    ...
    */
    ...
    void GenerateTalkData()
    {
        ...
        talkData.Add(91 + 40000, new string[] {"[그린]" +"\n" + "\n" + "피트라씨..!:4",
                                              "[그린]" +"\n" + "\n" + "피트라씨가 지금 어떤 상황인지 알고있어요. :4",
                                              "[피트라]" +"\n" + "\n" + "다른 사람들에게 말하지만 말아주세요.부탁입니다. :3" ,
                                              "[그린]" +"\n" + "\n" + "걱정마세요. :3" ,
                                              "[그린]" +"\n" + "\n" + "제가 도와드릴게요. :3" ,
                                              "[피트라]" +"\n" + "\n" + "네?:3" ,
                                              "[피트라]" +"\n" + "\n" + "그린씨가 절 왜... :3" ,
                                              "[그린]" +"\n" + "\n" + "피트라씨에게 받은 도움이 있거든요. :3" ,
                                              "[피트라]" +"\n" + "\n" + "제가 언제.. :4" ,
                                              "[그린]" +"\n" + "\n" + "기계에 깔린 절 구해주시려다 잘못돼서 초기화가 되긴 하셨지만,, :3" ,
                                              "[그린]" +"\n" + "\n" + "며칠전에 절 못알아보셔서 얼마나 서운했는지 몰라요. :3" ,
                                              "[피트라]" +"\n" + "\n" + "제가..그린씨를 돕다 초기화가 됐었다고요?:3" ,
                                              "[그린]" +"\n" + "\n" + "네, 그땐 고맙다는 말도 못했네요.:3",
                                              "[그린]" +"\n" + "\n" + "고마워요 피트라씨 :3",
                                              "[그린]" +"\n" + "\n" + "여기 1층 택배 출입구 카드예요. :3",
                                              "[그린]" +"\n" + "\n" + "피트라씨가 유일하게 탈출할 수 있는 길이죠. :3",
                                              "[피트라]" +"\n" + "\n" + "정말… 감사합니다 그린씨:1" ,
                                              "[그린]" +"\n" + "\n" + "저는 뒤따라오는 로봇들을 최대한 꺼볼게요.:3",
                                              "[그린]" +"\n" + "\n" + "오는 길에.. 수리실에서 조종 리모컨을 하나 주웠...거든요.:3",
                                              "[피트라]" +"\n" + "\n" + "정말… 감사합니다 그린씨:1" ,
                                              "[그린]" +"\n" + "\n" + "행운을 빌게요. 나중에 또 봐요. :3",
                                              "[피트라]" +"\n" + "\n" + "밖에서 봬요. :1" ,
                                            });
